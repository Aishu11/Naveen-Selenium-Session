...
public WebDriver driver;
	...
	//For Sanity we use BT - AccountsPAgeTest
	// For Regression, we use BM - AccountsPAgeTestBM (what if the application gets crashed, so for regression it is good to use Before Method scenario
}
